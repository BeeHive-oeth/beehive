...
/**
 * @author 0mllwntrmt3
 * @title Hive OETH Liquidity Pool
 * @notice Accumulates liquidity in OETH from LPs and distributes P&L in OETH
 */
contract HiveOETHPool is
    IOETHLiquidityPool,
    Ownable,
    ERC20("Hive OETH LP Token", "writeOETH")
{
    ...
    /*
     * @nonce A provider supplies OETH to the pool and receives writeOETH tokens
    ...
    /*
     * @nonce Provider burns writeOETH and receives OETH from the pool
     * @param amount Amount of OETH to receive
    ...
    /*
     * @nonce calls by HiveCallOptions to lock the funds
    ...
    /*
     * @nonce calls by HiveCallOptions to unlock the funds
    ...
    /*
     * @nonce calls by HivePutOptions to lock the premiums
    ...
    /*
     * @nonce calls by HivePutOptions to unlock the premiums after an option's expiraton
    ...
    /*
     * @nonce calls by HiveCallOptions to send funds to liquidity providers after an option's expiration
     * @param to Provider
    ...
    /*
     * @nonce Returns provider's share in OETH
     * @param account Provider's address
     * @return Provider's share in OETH
     */
    ...
    /*
     * @nonce Returns the amount of OETH available for withdrawals
    ...
    /*
     * @nonce Returns the total balance of OETH provided to the pool
