...
/**
 * @author 0mllwntrmt3
 * @title Hive OETH Put Options
 * @notice OETH Put Options Contract
 */
contract HivePutOptions is HiveOptions {
    IUniswapV2Router01 public uniswapRouter;
    HiveERCPool public pool;
    ...
    constructor(
        ...
        public
        HiveOptions(_priceProvider, HiveOptions.OptionType.Put)
    {
        token = _token;
        uniswapRouter = _uniswapRouter;
        pool = new HiveERCPool(token);
        approve();
    }
