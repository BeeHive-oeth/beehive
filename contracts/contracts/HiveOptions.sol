...
import "./HiveERCPool.sol";
import "./HiveOETHPool.sol";


/**
 * @author Original Author: 0mllwntrmt3
 * @title Hive: On-chain Options Trading Protocol on OETH
 * @notice Hive Protocol Options Contract
 */

abstract contract HiveOptions is Ownable {
    ...
    /**
     * @param pp The address of ChainLink OETH/USD price feed contract
     ...
     * @return settlementFee Amount to be distributed to the Hive token holders
     ...
     * @param period Option period in seconds (1 days <= period <= 4 weeks)
     * @param strike Strike price of the option
     * @param currentPrice Current price of OETH
